...
var ASM_CONSTS = {
    6180: ($0, $1, $2) => {
        turn_button_on_off(UTF8ToString($0), $1, $2)
    },
    6230: () => {
        window.requestAnimationFrame(Module._process_button_presses)
    },
    6294: () => performance.now(),
    6321: ($0, $1, $2) => {
        let audioContext = emscriptenGetAudioObject($0);
        let audioWorkletNode = emscriptenGetAudioObject($1);
        HEAPF32[$2 >> 2] = audioContext.sampleRate;
...
var _emscripten_start_wasm_audio_worklet_thread_async = (contextHandle, stackLowestAddress, stackSize, callback, userData) => {
    ...
    audioWorklet.addModule("keyboard.aw.js").then(() => {
...
var _process_button_presses = Module["_process_button_presses"] = a0 => (_process_button_presses = Module["_process_button_presses"] = wasmExports["p"])(a0);
var _malloc = Module["_malloc"] = a0 => (_malloc = Module["_malloc"] = wasmExports["q"])(a0);
var _play_string = Module["_play_string"] = a0 => (_play_string = Module["_play_string"] = wasmExports["r"])(a0);
var _play_string_keyboard = Module["_play_string_keyboard"] = a0 => (_play_string_keyboard = Module["_play_string_keyboard"] = wasmExports["s"])(a0);
var _play_interruptible_note = Module["_play_interruptible_note"] = (a0, a1) => (_play_interruptible_note = Module["_play_interruptible_note"] = wasmExports["t"])(a0, a1);
var _mute_interruptible_note = Module["_mute_interruptible_note"] = a0 => (_mute_interruptible_note = Module["_mute_interruptible_note"] = wasmExports["u"])(a0);
var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["v"])(a0, a1);
var ___errno_location = () => (___errno_location = wasmExports["__errno_location"])();
var _emscripten_wasm_worker_initialize = Module["_emscripten_wasm_worker_initialize"] = (a0, a1) => (_emscripten_wasm_worker_initialize = Module["_emscripten_wasm_worker_initialize"] = wasmExports["x"])(a0, a1);
...
// Executing without a user gesture produces the following error in Chrome/Firefox:
...
Module["start"] = function() {
    if (ready) {
        ...
        console.warn("Called start before it was ready")
    }
};
